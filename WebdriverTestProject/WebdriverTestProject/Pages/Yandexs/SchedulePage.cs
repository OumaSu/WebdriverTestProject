...
namespace WebdriverTestProject.Pages.Yandexs
{
    public class SchedulePage : PageBase
    {
        ...
        public StaticControl SearchButton => new StaticControl(By.XPath("//*[@class='y-button_islet-rasp-search _pin-left _init']")); //y-button_islet-rasp-search _pin-left _init xh-highlight

        public void SearchTicket(string from, string to, DateTime date)
        {
